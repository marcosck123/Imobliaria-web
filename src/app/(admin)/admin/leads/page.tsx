...
const mockLeads = [
  {
    ...
    phone: '(11) 98765-4321',
    property: 'Casa de Luxo no Jardins',
    message: 'Gostaria de agendar uma visita para o final de semana.',
    status: 'novo' as LeadStatus,
    date: '2024-05-04T09:30:00Z',
  },
  {
    id: '2',
    ...
    phone: '(11) 97654-3210',
    property: 'Apartamento Moderno em Pinheiros',
    message: 'Tenho interesse em comprar. Qual o valor mínimo aceito?',
  ...
  },
  {
    ...
    phone: '(11) 96543-2109',
    property: 'Apartamento para Alugar em Moema',
    message: 'Preciso do imóvel para agosto. Aceita animais domésticos?',
    status: 'em_atendimento' as LeadStatus,
  ...
  },
  {
    ...
    phone: '(11) 95432-1098',
    property: 'Casa em Condomínio Barão Geraldo',
    message: 'Fechei negócio! Enviarei os documentos amanhã.',
  ...
  },
  {
    ...
    phone: '(11) 94321-0987',
    property: 'Terreno em Alphaville Campinas',
    message: 'Não tenho mais interesse. Achei algo melhor.',
  ...
  },
  {
    ...
    phone: '(11) 93210-9876',
    property: 'Apartamento Beira-Mar em Santos',
    message: 'Posso visitar no sábado às 10h? Moro em SP mas posso ir.',
    status: 'novo' as LeadStatus,
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            {mockLeads.length} contatos recebidos · {novos} novo{novos !== 1 ? 's' : ''}
          </p>
        </div>
      </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-0.5">
                      Interesse em: <span className="text-gray-700 font-medium">{lead.property}</span>
                    </p>
